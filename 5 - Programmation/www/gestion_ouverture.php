...
if (isset($_POST['submit'])){
  if(!empty($_POST['heure_o'] && (!empty($_POST['minute_o'] && (!empty($_POST['day'])))))){
    ...
    str_pad($heure_o, 8, '0', STR_PAD_LEFT);    
    $minute_o = str_pad($_POST['minute_o'], 2, '0', STR_PAD_LEFT);  
    $day = $_POST['day'];

    $sql = "UPDATE test SET heure_o='$heure_o', minute_o='$minute_o' WHERE id=$day";

    if ($con->query($sql) === TRUE) {
        echo "";?>

          <center><h3 class="alert alert-success" role="alert">  <?php print($heure_o); ?> : <?php print($minute_o); ?> a été enregistré pour le jour sélectionné </h3></center><br>
  ...
  if (empty($_POST['heure_o'])){
    echo ""; ?>

      <center><h3 class="alert alert-danger" role="alert">  Veuillez remplir le champ d'heure d'ouverture </h3></center><br>


  <?php 

} 
  if (empty($_POST['minute_o'])){
    echo ""; ?>

      <center><h3 class="alert alert-danger" role="alert">  Veuillez remplir le champ des minutes d'ouverture </h3></center><br>
...
<div class="gestion">
  <center><h3>Choisir heures d'ouverture</h3></center>
...
<br><br><br>
          <div class="def_heure_o">
            <input type="number" name="heure_o" class="def_heure_o" size=1 onKeyup="autotab(this, document.sampleform.minute_o)" maxlength=2 minlength="0" min="00" max="23" placeholder="HH" >
          </div>

          
          <div class="def_minute_o">
            <input type="number" name="minute_o" size=2 onKeyup="autotab(this, document.sampleform.submit)" class="def_minute_o" maxlength=2 minlength="0" min="00" max="59" placeholder="MM">
          </div>

          <center><input type="submit" value="Enregistrer heure d'ouverture" name="submit" class="btn btn-default"></center><br>
